      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            At Musshk, we are committed to protecting your privacy and ensuring the security of your personal information. 
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            browser type, device information, and browsing patterns.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            and personalize content. You can control cookies through your browser settings, but this may affect website 
            functionality.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mt-2">
            ...
            Addresses: Surat, Gujarat, India | Gurgaon, Haryana, India
          </p>
        </section>
      </div>
    </div>
